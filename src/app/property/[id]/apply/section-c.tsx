...
export default function SectionC() {
  ...
  function onSubmit(values: z.infer<typeof schema>) {
    // Convert possessionTiming object to string
    let possessionTimingString = "";
    if (values.possessionTiming.immediately) possessionTimingString = "Immediately";
    else if (values.possessionTiming.oneMonth) possessionTimingString = "One Month";
    else if (values.possessionTiming.threeMonths) possessionTimingString = "Three Months";

    setTenant({
      ...values,
      possessionTiming: possessionTimingString,
    });
    goToNextStep();
  }
